...
router.post('/starset/', function(req, res, next) {
    ...
    database.query(sql0, sqlArr0, (err, data)=>{
        ...
        if(data.length >= 1) {
            ...
            let sql = "INSERT INTO star SET id=?,song=?,artist=?,platform=?,songid=?,img=?"
            let sqlArr = [id, req.body.song, req.body.artist, req.body.platform, req.body.songid, req.body.img]
